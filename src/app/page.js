    ...
    <div class="tet-container">
        ...
        <div class="tet-banner">
            ...
            <div class="tet-banner-text">
                Tết là dịp đoàn viên, đồng thời cũng là dịp nạp năng lượng cho một năm mới tràn đầy phấn khởi. Và những chuyến du xuân
                chính là sự khởi động hoàn hảo, mở ra một hành trình mới thật nhiều niềm vui và hạnh phúc.<br/><br/>
                Hãy chọn cho mình một lịch trình tour độc đáo, hấp dẫn với sự đồng hành của Vietnam Booking - Nhà tổ chức Tour chuyên
                nghiệp và uy tín. Gọi ngay Hotline <a class="tet-banner-tel" href="tel:19003398">1900 3398</a> để được tư vấn đặt tour và nhận "lì xì" lên đến 30% ngay hôm nay bạn nhé!
            </div>
        </div>
        ...
        <div class="tet-tour tour-trongnuoc">
            ...
            <div class="tour-main">
                <ul class="nav nav-tabs nav-justified tet-custom-nav-tab">
                    <li class="active" ><a href="#mienbac" data-toggle="tab">
                        <img class="tour-tab-img" src="/images/tour/trongnuoc/mienbac.png" />
                    </a></li>
                    <li class="#"><a href="#mientrung" data-toggle="tab">
                            <img class="tour-tab-img" src="/images/tour/trongnuoc/mientrung.png" />
                        </a></li>
                    <li class="#"><a href="#miennam" data-toggle="tab">
                        ...
                        {/* <!-- ITEM FOREACH --> */}
                        {
                            ...
                            tourMienBac.map((item, index) => (
                                <div class="tet-tour-item">
                                    ...
                                    <img class="tet-tour-item-img" src={`/images/tour-images/noi_dia/mien_bac/${item.id}.jpg`}/>
                                    <h3 class="tet-tour-item-name">
                                        {item.name}
                                    </h3>
                        ...
                        <div class="tet-tour-list-content">
                            {
                                ...
                                tourMienTrung.map((item, index) => (
                                    <div class="tet-tour-item">
                                        <img class="tet-tour-item-mask" src="/images/tour/tour_mask.png" />
                                        <img class="tet-tour-item-img" src={`/images/tour-images/noi_dia/mien_trung/${item.id}.jpg`}/>
                                        <h3 class="tet-tour-item-name">
                                            {item.name}
                                        </h3>
                                        <div class="tet-tour-item-price">
                        ...
                        <div class="tet-tour-list-content">
                            {
                                ...
                                tourMienNam.map((item, index) => (
                                    <div class="tet-tour-item">
                                        <img class="tet-tour-item-mask" src="/images/tour/tour_mask.png" />
                                        <img class="tet-tour-item-img" src={`/images/tour-images/noi_dia/mien_nam/${item.id}.jpg`}/>
                                        <h3 class="tet-tour-item-name">
                                            {item.name}
                                        </h3>
                                        <div class="tet-tour-item-price">
        ...
        <div class="tet-tour tour-quocte">
            ...
            <div class="tour-main">
                <ul class="nav nav-tabs nav-justified tet-custom-nav-tab">
                    <li class="active"><a href="#start_hanoi" data-toggle="tab">
                            <img class="tour-tab-img" src="/images/tour/quocte/xuatphat_hanoi.png" />
                        </a></li>
                    <li class="#"><a href="#start_danang" data-toggle="tab">
                            <img class="tour-tab-img" src="/images/tour/quocte/xuatphat_danang.png" />
                        </a></li>
                    <li class="#"><a href="#start_hcm" data-toggle="tab">
                        ...
                        <div class="tet-tour-list-content">
                            {
                                ...
                                tourTuHN.map((item, index) => (
                                    <div class="tet-tour-item">
                                        <img class="tet-tour-item-mask" src="/images/tour/tour_mask.png" />
                                        <img class="tet-tour-item-img" src={`/images/tour-images/quoc_te/ha_noi/${item.id}.jpg`}/>
                                        <h3 class="tet-tour-item-name">
                                            {item.name}
                                        </h3>
                                        <div class="tet-tour-item-price">
                        ...
                        <div class="tet-tour-list-content">
                            {
                                ...
                                tourTuDN.map((item, index) => (
                                    <div class="tet-tour-item">
                                        <img class="tet-tour-item-mask" src="/images/tour/tour_mask.png" />
                                        <img class="tet-tour-item-img" src={`/images/tour-images/quoc_te/da_nang/${item.id}.jpg`}/>
                                        <h3 class="tet-tour-item-name">
                                            {item.name}
                                        </h3>
                                        <div class="tet-tour-item-price">
                        ...
                        <div class="tet-tour-list-content">
                            {
                                ...
                                tourTuHCM.map((item, index) => (
                                    <div class="tet-tour-item">
                                        <img class="tet-tour-item-mask" src="/images/tour/tour_mask.png" />
                                        <img class="tet-tour-item-img" src={`/images/tour-images/quoc_te/hcm/${item.id}.jpg`}/>
                                        <h3 class="tet-tour-item-name">
                                            {item.name}
                                        </h3>
                                        <div class="tet-tour-item-price">
        ...
        <div class="tet-thanks">
            <div class="tet-thanks-text">
                <div class="tet-thanks-title">
                    Trân trọng cảm ơn quý khách
                </div>
                <div class="tet-thanks-desc">
                    Đã tin tưởng lựa chọn Vietnam Booking trong mỗi hành trình.
                </div>
            </div>
                    ...
                    <div class="footer-info-container">
                        <div class="footer-info">
                            <div class="footer-info-svg">
                                ...
                                <a href="https://www.vietnambooking.com" class="footer-info-text">www.vietnambooking.com</a>
                        </div>
                        <div class="footer-info">
                            <div class="footer-info-svg">
                                ...
                                <a href="mailto:dulich@vietnambooking.com" class="footer-info-text">dulich@vietnambooking.com</a>
                        </div>
                        
                    </div>
                </div>
                <div class="tet-info-right">
                    <div class="tet-info-company">
                        dịch vụ lữ hành
                        vietnam booking
                    </div>
                    ...
                    <div>
                        ...
                        <a href="tel:1900 3398" class="tet-tongdai-num">1900 3398</a>
                    </div>
                </div>
            </div>
        </div>
