...
export default function Home() {
  ...
  const handleClickTour = (tour) => {
    let objectCopy = Object.assign({}, dataAnalytics);
    const dataWrite = {
      id: dataAnalytics.dataClick.length,
      link: tour.link,
      name: tour.name,
      price: tour.price,
      location: tour.type,
    ...
    objectCopy?.dataClick.push(dataWrite);
    objectCopy.totalClick += 1;
    setDataAnalytics(objectCopy);
    localStorage.setItem('dataAnalytics', JSON.stringify(objectCopy));
  };
  ...
  const handleSubmit = async () => {
    if (name.length < 3) {
      Swal.fire({
        ...
        confirmButtonText:
          '<img class="tet-popup-xacnhan-btn" src="/images/popup_xacnhan.png" />',
        customClass: {
  ...
  useEffect(() => {
    const checkData = localStorage.getItem("dataAnalytics");
    if (!checkData) {
      const initialData = {
        totalClick: 0,
        dataClick: [
          {
            id: 0,
            name: "Initial name",
            link: "https://event.vietnambooking.com/",
            time: "21:00:00 05/01/2024",
            location: "Vietnambooking",
            price: "0",
          },
        ],
      };
      localStorage.setItem("dataAnalytics", JSON.stringify(initialData));
    } else {
      setDataAnalytics(JSON.parse(checkData));
    }
  }, []);
    ...
    <div class="tet-container">
      ...
      <div class="tet-banner">
        ...
        <div class="tet-banner-text">
          Tết là dịp đoàn viên, đồng thời cũng là dịp nạp năng lượng cho một năm
          mới tràn đầy phấn khởi. Và những chuyến du xuân chính là sự khởi động
          hoàn hảo, mở ra một hành trình mới thật nhiều niềm vui và hạnh phúc.
          <br />
          <br />
          Hãy chọn cho mình một lịch trình tour độc đáo, hấp dẫn với sự đồng
          hành của Vietnam Booking - Nhà tổ chức Tour chuyên nghiệp và uy tín.
          Gọi ngay Hotline{" "}
          <a class="tet-banner-tel" href="tel:19003398">
            1900 3398
          </a>{" "}
          để được tư vấn đặt tour và nhận "lì xì" lên đến 30% ngay hôm nay bạn
          nhé!
        </div>
      </div>
      ...
      <div class="tet-tour tour-trongnuoc">
        ...
        <div class="tour-header">
          <img
            class="tour-header-img"
            src="/images/tour/header_trongnuoc.png"
          />
        </div>
        <div class="tour-main">
          <ul class="nav nav-tabs nav-justified tet-custom-nav-tab">
            <li class="active">
              <a href="#mienbac" data-toggle="tab">
                <img
                  class="tour-tab-img"
                  src="/images/tour/trongnuoc/mienbac.png"
                />
              </a>
            </li>
            <li class="#">
              <a href="#mientrung" data-toggle="tab">
                <img
                  class="tour-tab-img"
                  src="/images/tour/trongnuoc/mientrung.png"
                />
              </a>
            </li>
            <li class="#">
              <a href="#miennam" data-toggle="tab">
                <img
                  class="tour-tab-img"
                  src="/images/tour/trongnuoc/miennam.png"
                />
              </a>
            </li>
          </ul>
                ...
                {tourMienBac &&
                  tourMienBac.map((item, index) => (
                    <div class="tet-tour-item">
                      <img
                        class="tet-tour-item-mask"
                        src="/images/tour/tour_mask.png"
                      />
                      <img
          ...
          <ul class="nav nav-tabs nav-justified tet-custom-nav-tab">
            <li class="active">
              <a href="#start_hanoi" data-toggle="tab">
                <img
                  class="tour-tab-img"
                  src="/images/tour/quocte/xuatphat_hanoi.png"
                />
              </a>
            </li>
            <li class="#">
              <a href="#start_danang" data-toggle="tab">
                <img
                  class="tour-tab-img"
                  src="/images/tour/quocte/xuatphat_danang.png"
                />
              </a>
            </li>
            <li class="#">
              <a href="#start_hcm" data-toggle="tab">
                <img
                  class="tour-tab-img"
                  src="/images/tour/quocte/xuatphat_hcm.png"
                />
              </a>
            </li>
          </ul>
            ...
            <div class="tet-form-container">
              ...
              <button disabled={disabled} class="tet-form-submit" type="submit">
                <img
                  ...
                  class="tet-form-submit-img"
                  src="/images/dang-ky.png"
                />
              </button>
            </div>
          </div>
          ...
          <div class="tet-bottom-container">
            ...
            <div class="tet-info-right">
              <div class="tet-info-company">
                dịch vụ lữ hành vietnam booking
              </div>
